      ...
      {[
        {
          ...
          full: "Descubre los beneficios de la práctica de yoga y la meditación como complemento a tu proceso psicoterapéutico, mejorando tu equilibrio emocional, concentración y bienestar integral."
        },
        {
          title: "Arte Terapia",
          img: "https://images.unsplash.com/photo-1513364776144-60967b0f800f",
          short: "Expresión emocional a través del arte.",
          full: "Encuentra en el arte una forma de expresar emociones reprimidas, desarrollar tu creatividad y transformar tu vida en una obra consciente dirigida por ti."
        },
        {
          title: "Grupos de Apoyo",
          img: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac",
          short: "Comunidad y apoyo emocional.",
          full: "Creemos en el poder del ser social, por eso generamos espacios de conexión donde las personas encuentran apoyo, comprensión y crecimiento en comunidad."
        },
        {
          ...
          full: "Apostamos por la psicoeducación, programación neurolingüística y el autodesarrollo, brindando herramientas prácticas con profesionales altamente capacitados."
        }
      ].map((item, i) => (
...
<section className="py-24 px-6 bg-[#F5F1EB] text-center">
  ...
  className="mx-auto w-[80%] md:w-[900px] mb-12 drop-shadow-2xl"
/>
  ...
  >
    <h2 className="text-3xl md:text-4xl font-bold mb-4">
      Contamos con el mejor plan de trabajo
    </h2>

    <p className="text-lg text-gray-600">
      Garantizando resultados óptimos en cada consultante, que contará con estrategias no solo
      innovadoras, sino también a la medida de cada ser, respaldando los casos
      basándonos en la evidencia científica, con un equipo de profesionales altamente capacitados y comprometidos con el bienestar 
      de cada persona que confía en nosotros, generando así resultados que perduren en el tiempo
      de cada persona.
    </p>
  </motion.div>
...
<section className="py-24 bg-[#F5F1EB]">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 md:h-[600px]">
      ...
      {/* CARD GRANDE */}
      <div className="md:col-span-2 md:row-span-2 bg-white rounded-2xl p-10 flex flex-col justify-end relative overflow-hidden group shadow">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-600 max-w-sm">
            Espacios de juego y diálogo adaptados para el desarrollo emocional de los más pequeños.
          </p>
        </div>
      ...
      {/* YOGA */}
      <div className="bg-white rounded-2xl p-8 flex flex-col items-center text-center justify-center border border-[#A3B18A]/10 shadow">
      ...
      {/* ESTIMULACIÓN */}
      <div className="md:col-span-2 bg-[#EFE8E0] rounded-2xl p-10 flex items-center gap-8 border border-[#A3B18A]/10 shadow">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600">
            Bases sólidas para un crecimiento saludable y feliz.
          </p>
        </div>

        <div className="text-5xl text-[#A3B18A]/60">
          🧩
        </div>
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="text-center mb-24">
      ...
      <p className="text-gray-600 max-w-2xl mx-auto italic">
        Alquiler de espacio terapéutico | Contáctenos y juntos mejoraremos la psicoterapia. 
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
      ...
      {[
        ...
        {
          name: "Santi Giraldo",
          role: "Instructor de Mindfulness & Yoga",
        ...
        <div key={i} className="group">
          ...
          <p className="text-[#A3B18A] text-sm font-medium mb-4">
            {item.role}
          </p>

          {/* BOTÓN */}
          <button className="w-full py-3 rounded-full border border-[#A3B18A] text-sm font-semibold hover:bg-[#A3B18A] hover:text-white transition">
            Agendar
          </button>
...
<div className="w-full h-[350px] rounded-2xl overflow-hidden shadow-lg">
  ...
  ></iframe>
      ...
      <section className="py-16 bg-green-500 text-white text-center">
        ...
        <button className="bg-white text-green-600 px-6 py-3 rounded-xl">
          Agendar cita
        </button>
      </section>
